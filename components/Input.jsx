import { EmojiHappyIcon, LocationMarkerIcon, PhotographIcon, CalendarIcon, ChartBarIcon } from "@heroicons/react/outline";

const Input = () => {
  return (
    <div className="flex border-b border-gray-200 p-3 space-x-3">
        <img src="https://images.pexels.com/photos/220453/pexels-photo-220453.jpeg?auto=compress&cs=tinysrgb&w=600" alt="John Doe" className="object-cover h-11 w-11 rounded-full cursor-pointer hover:brightness-95"/>
